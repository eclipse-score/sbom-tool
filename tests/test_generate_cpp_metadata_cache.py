...
from scripts.generate_cpp_metadata_cache import convert_cdxgen_to_cache
...
def _write_cdx(components: list) -> str:
    """Write a CycloneDX document to a temp file; return the file path."""
